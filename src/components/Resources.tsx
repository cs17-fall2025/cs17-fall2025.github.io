    ...
    <div className="page-content">
      ...
      <div className="resource-div">
        <div className="resource-column">
          <p>General</p>
          <a href="https://docs.google.com/document/d/1GtksfSOpsYO5ZrPZWnWGeNF-wlyGrqLCks4iBqg2ark/edit?tab=t.0">
        ...
        <div className="resource-column">
          ...
          <a href="https://drive.google.com/file/d/1ghLCBpxztGqHlXMkKsOzVSjy9OlEZYVc/view?usp=sharing">
            <div className="resource-box">Style Guide</div>
          </a>
          <a href="https://drive.google.com/file/d/1iTQLs6Nqz6LthyQtOrVA9caR6FlpoYH8/view?usp=sharing">
            <div className="resource-box">Racket Style Guide</div>
          </a>
          <a href="https://drive.google.com/file/d/1wAeUiFz3aoh1oQ-W9jBLBk0-xCO1RSb0/view?usp=sharing">
            <div className="resource-box">Racket Teachpack</div>
          </a>

          <a href="https://drive.google.com/file/d/1t7wTIHGm8Yurl2sznWhJARglo5akl1Rw/view?usp=sharing">
            <div className="resource-box">ReasonML Debugging</div>
          </a>
          <a href="https://drive.google.com/file/d/1L37uUaRYlr9mbERMTjilOUB3W4dVYHVc/view?usp=sharing">
            <div className="resource-box">ReasonML Install</div>
          </a>
          <a href="https://drive.google.com/file/d/1FKOZ89J19njd-bIlIMg6Im6vfcGIm2kI/view?usp=sharing">
        ...
        <div className="resource-column">
          ...
          <a href="https://drive.google.com/file/d/1xvXDuuu05A_U41vnwrogDUkfA2qEO3Ot/view?usp=sharing">
            <div className="resource-box">EdStem Policies</div>
          </a>
          <a href="https://drive.google.com/file/d/1DRVNiZEo7KM8F8eCtYzeT-7ytiEUeNfN/view?usp=sharing">
            <div className="resource-box">Course Policies</div>
          </a>
          <a href="https://drive.google.com/file/d/1aCD0yGWQUCmAhr3s_LqYqe4hHQU8NjPL/view?usp=sharing">
            <div className="resource-box">Hours Policies</div>
          </a>
          <a href="https://drive.google.com/file/d/1g9A0VKzL2Ao4yAD_N6BLSLx9xlCy4_bv/view?usp=sharing">
            <div className="resource-box">Pair Programming</div>
          </a>
          <a href="https://drive.google.com/file/d/15oF8xQTh6kqYe2aFbuusQt3xOD9Y93ba/view?usp=sharing">
